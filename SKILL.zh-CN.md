...
3. Set your vault path at the top of `_directory-map.md` reference (or replace `$VAULT_PATH` with your actual path)
...
/organize                     — Organize current conversation context into notes
...
Read `$VAULT_PATH/_directory-map.md` to get all directory classifications and keyword mappings.
